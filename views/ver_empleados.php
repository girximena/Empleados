...
<body class="bg-primary">
    <div class="container">
        <h1 class="text-light">Detalles del Empleado</h1>
        <form action="" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" value="<?php echo $empleado->getNombre(); ?>" readonly>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" value="<?php echo $empleado->getCargo(); ?>" readonly>
            </div>
            <a class="btn btn-secondary" href="list_empleados.php" role="button">Volver</a>
        </form>
    </div>
